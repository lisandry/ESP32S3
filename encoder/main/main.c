...
// VAO AO MOTOR
#define MOTOR_PIN_GPIO_A1 GPIO_NUM_5 /**< Pino GPIO para direção 1 do motor */
#define MOTOR_PIN_GPIO_A2 GPIO_NUM_4 /**< Pino GPIO para direção 2 do motor */


// VEM DO DRV
#define PWM_GPIO_A GPIO_NUM_15 
#define PWM_GPIO_B GPIO_NUM_16 
// Configuração PCNT
...
#define Kc 1.8 // Ganho proporcional
#define Kd 0.02 // Ganho derivativo
#define Ki 0.05 // Ganho integrativo
...
void IRAM_ATTR timer_isr(void *arg) {
   ...
   erro = referencia - (Gadc*e0);
    ...
    sinal_controle = proporcional+ derivador + integrador ;
...
void app_main(void)
{
    ...
    pcnt_chan_config_t chan_config = {
        .edge_gpio_num = PWM_GPIO_A,
        .level_gpio_num = PWM_GPIO_B,
    };
